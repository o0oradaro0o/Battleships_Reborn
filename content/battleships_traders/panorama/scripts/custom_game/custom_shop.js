...
var starttime = 0;
var yaw = 0;
var NewShopUI = $.GetContextPanel()
  .GetParent()
  .GetParent()
  .GetParent()
  .FindChildTraverse("HUDElements")
  .FindChildTraverse("shop");
var scoreBoardGoodCont = $.GetContextPanel()
  .GetParent()
  .GetParent()
  .GetParent()
  .FindChildTraverse("HUDElements")
  .FindChildTraverse("topbar")
  .FindChildTraverse("TopBarRadiantTeam")
  .FindChildTraverse("TopBarRadiantPlayers")
  .FindChildTraverse("RadiantTeamScorePlayers")
  .FindChildTraverse("TopBarRadiantPlayersContainer");
var nearistShop;
var topBarBadCont = $.GetContextPanel()
  .GetParent()
  .GetParent()
  .GetParent()
  .FindChildTraverse("HUDElements")
  .FindChildTraverse("topbar")
  .FindChildTraverse("TopBarDireTeam")
  .FindChildTraverse("TopBarDirePlayers")
  .FindChildTraverse("DireTeamScorePlayers")
  .FindChildTraverse("TopBarDirePlayersContainer");
...
function showTrade() {
  ...
  var newBotRightUI = $.GetContextPanel()
    .GetParent()
    .GetParent()
    .GetParent()
    .FindChildTraverse("HUDElements")
...
function resetHeroIcons() {
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer0")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer0")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer1")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer1")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer2")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer2")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer3")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer3")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer4")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer4")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer5")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer5")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer6")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer6")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer7")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer7")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer8")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer8")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer9")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer9")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  if (scoreBoardGoodCont.FindChildTraverse("RadiantPlayer10")) {
    SetImageForPanel(
      scoreBoardGoodCont
        .FindChildTraverse("RadiantPlayer10")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  ...
  if (topBarBadCont.FindChildTraverse("DirePlayer10")) {
    SetImageForPanel(
      topBarBadCont
        .FindChildTraverse("DirePlayer10")
        .FindChildTraverse("SlantedContainerPanel")
    );
  }
  var scoreboard = $.GetContextPanel()
    .GetParent()
    .GetParent()
    .GetParent()
    .FindChildTraverse("HUDElements")
    .FindChildTraverse("scoreboard")
    .FindChildTraverse("Background");

  // for scoreboard
  if (
    scoreboard
      .FindChildTraverse("RadiantTeamContainer")
      .FindChildTraverse("RadiantPlayer0")
  ) {
    SetImageForScorePanel(
      scoreboard
        .FindChildTraverse("RadiantTeamContainer")
        .FindChildTraverse("RadiantPlayer0")
    );
  ...
  if (
    scoreboard
      .FindChildTraverse("DireTeamContainer")
      .FindChildTraverse("DirePlayer0")
  ) {
    SetImageForScorePanel(
      scoreboard
...
function SetImageForScorePanel(topBarHeroPanel) {
  ...
  topBarHeroPanel.MoveChildBefore(
    topBarHeroPanel.FindChildTraverse("ReplacmentHeroImage"),
    topBarHeroPanel.FindChildTraverse("HeroImage")
  );
  topBarHeroPanel.FindChildTraverse("ReplacmentHeroImage").style.width = "67px";
  topBarHeroPanel.FindChildTraverse("ReplacmentHeroImage").style.height =
    "38px";
  topBarHeroPanel.FindChildTraverse("ReplacmentHeroImage").style.verticalAlign =
    "center";
  heroimage.hittest = false;
  var heroImageName =
    "file://{images}/custom_game/Boats/" +
    topBarHeroPanel.FindChildTraverse("HeroImage").heroname +
    ".png";
...
function replaceShopUI() {
  if (
    ...
    $.GetContextPanel()
      ...
      .FindChildTraverse("GuideFlyout")
      .FindChildTraverse("ItemsArea")
      .FindChildTraverse("ItemBuildContainer").style.visibility = "visible";
    ...
    $.GetContextPanel()
      ...
      .FindChildTraverse("ItemsArea")
      .SetParent(
        NewShopUI.FindChildTraverse("Main").FindChildTraverse("HeightLimiter")
      );
  }
  NewShopUI.FindChildTraverse("Main")
    .FindChildTraverse("HeightLimiter")
    .FindChildTraverse("GridMainShop").style.visibility = "collapse";
  NewShopUI.FindChildTraverse("Main")
    .FindChildTraverse("HeightLimiter")
    .FindChildTraverse("CommonItems").style.visibility = "collapse";

  catigoriesUI = NewShopUI.FindChildTraverse("Main")
    .FindChildTraverse("HeightLimiter")
    .FindChildTraverse("ItemsArea")
    .FindChildTraverse("ItemBuildContainer")
    .FindChildTraverse("ItemBuild")
    .FindChildTraverse("Categories");
...
function fixUI() {
  ...
  var sidenotif = $.GetContextPanel()
    .GetParent()
    .GetParent()
    .GetParent()
    .FindChildTraverse("HUDElements")
    .FindChildTraverse("combat_events");

  var topnotif = $.GetContextPanel()
    .GetParent()
    .GetParent()
    .GetParent()
    .FindChildTraverse("HUDElements")
    .FindChildTraverse("FightRecap");

  var buyback = $.GetContextPanel()
    .GetParent()
    .GetParent()
    .GetParent()
    .FindChildTraverse("HUDElements")
  ...
  newCenterUI
    ...
    .FindChildTraverse("BuybackButton").style.visibility = "collapse";
  ...
  scoreboard.MoveChildBefore(
    scoreboard.FindChildTraverse("DireTeamContainer"),
    scoreboard.FindChildTraverse("RadiantTeamContainer")
  );
  scoreboard.MoveChildBefore(
    scoreboard.FindChildTraverse("DireHeader"),
    scoreboard.FindChildTraverse("RadiantTeamContainer")
  );
  scoreboard
    .FindChildTraverse("DireHeader")
    .FindChildTraverse("DireTeamLabel").text = "The South Empire";
  scoreboard
    .FindChildTraverse("RadiantHeader")
    .FindChildTraverse("RadiantTeamLabel").text = "The North Empire";
  scoreboard
    .FindChildTraverse("RadiantHeader")
    .FindChildTraverse("RadiantTeamLabel").style.textShadow =
    "0px 0px 6px 1.0 #E74D088F";
  scoreboard
    .FindChildTraverse("DireHeader")
    .FindChildTraverse("DireTeamLabel").style.textShadow =
    "0px 0px 6px 1.0 #9BE40C8F";
  scoreboard
    .FindChildTraverse("RadiantHeader")
    .FindChildTraverse("RadiantScoreLabel").style.textShadow =
    "0px 0px 6px 1.0 #E74D088F";
  scoreboard
    .FindChildTraverse("DireHeader")
    .FindChildTraverse("DireScoreLabel").style.textShadow =
    "0px 0px 6px 1.0 #9BE40C8F";
  ...
  newCenterUI
    ...
    .FindChildTraverse("StatBranch").style.visibility = "collapse";
  newCenterUI
    .FindChildTraverse("AbilitiesAndStatBranch")
  ...
  newCenterUI
    ...
    .FindChildTraverse("inventory_backpack_list").style.visibility = "collapse";
  //--------------bot right -----------------
  ...
  newBotRightUI
    .FindChildTraverse("quickbuy")
    .FindChildTraverse("ShopCourierControls")
    .FindChildTraverse("ShopButton").style.horizontalAlign = "right";
  ...
  newBotRightUI
    .FindChildTraverse("quickbuy")
    .FindChildTraverse("ShopCourierControls").style.width = "100%";

  newBotRightUI
    .FindChildTraverse("quickbuy")
    .FindChildTraverse("ShopCourierControls").style.marginRight = "12px";
  newBotRightUI
    .FindChildTraverse("quickbuy")
...
function showShips() {
  ...
  if (shipShopShow == false) {
    ...
    if (
      ...
      $("#ship_shop_content_holder").SetParent(
        NewShopUI.FindChildTraverse("Main").FindChildTraverse("HeightLimiter")
      );
    }
    NewShopUI.FindChildTraverse("Main")
...
function show1ks() {
  if (
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("one_ks").style.height == "310.0px"
  ) {
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("one_ks").style.height = "0px";
  } else {
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("one_ks").style.height = "320px";
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("three_ks").style.height = "0px";
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("six_ks").style.height = "0px";
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("ten_ks").style.height = "0px";
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("trader_ships").style.height = "0px";
  }
}
...
function show3ks() {
  if (
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("three_ks").style.height == "310.0px"
  ) {
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
    ...
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("three_ks").style.height = "320px";
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("one_ks").style.height = "0px";
...
function show6ks() {
  if (
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("six_ks").style.height == "310.0px"
  ) {
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
    ...
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("six_ks").style.height = "320px";
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("one_ks").style.height = "0px";
...
function show10ks() {
  if (
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("ten_ks").style.height == "310.0px"
  ) {
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
    ...
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("ten_ks").style.height = "320px";
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("one_ks").style.height = "0px";
...
function showtraders() {
  if (
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("trader_ships").style.height == "310.0px"
  ) {
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
    ...
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("trader_ships").style.height = "320px";
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("one_ks").style.height = "0px";
...
function showText(BoatName, AbilityName) {
  ...
  $("#" + BoatName + "_ability_desc").text = $.Localize(
    "#" + AbilityName + "_Description"
  );
}
...
function showDetails(BoatName) {
  ...
  if (
    BoatName == "hide" ||
    $("#" + BoatName).style.height == "460.0px" ||
    $("#" + BoatName).style.height == "490.0px"
  ) {
...
function buyBoat(BoatName, cost) {
  ...
  $.Schedule(0.2, resetHeroIcons);
  $.Schedule(0.2, closeShipShop);
}
...
function setSellValue(BoatName) {
  ...
  if (currentGold > GetBoatValue(BoatName)) {
    NewShopUI.FindChildTraverse("Main")
      .FindChildTraverse("HeightLimiter")
      .FindChildTraverse("ship_shop_content_holder")
      .FindChildTraverse("SellValueHoplder")
      .FindChildTraverse("SellValue").text = GetBoatValue(BoatName) * 0.75;
  }
}
...
function GetBoatValue(BoatName) {
  ...
  if (BoatName.indexOf("disruptor") !== -1) return 3000;
  else if (BoatName.indexOf("ursa") !== -1) return 12000;
  else if (BoatName.indexOf("meepo") !== -1) return 6000;
  else if (BoatName.indexOf("tidehunter") !== -1) return 1000;
  else if (BoatName.indexOf("apparition") !== -1) return 1000;
  else if (BoatName.indexOf("rattletrap") !== -1) return 1000;
  else if (BoatName.indexOf("batrider") !== -1) return 1000;
  else if (BoatName.indexOf("winter_wyvern") !== -1) return 3000;
  else if (BoatName.indexOf("storm_spirit") !== -1) return 3000;
  else if (BoatName.indexOf("brewmaster") !== -1) return 3000;
  else if (BoatName.indexOf("ember_spirit") !== -1) return 6000;
  else if (BoatName.indexOf("slark") !== -1) return 6000;
  else if (BoatName.indexOf("shredder") !== -1) return 6000;
  else if (BoatName.indexOf("jakiro") !== -1) return 6000;
  else if (BoatName.indexOf("lion") !== -1) return 3000;
  else if (BoatName.indexOf("tusk") !== -1) return 12000;
  else if (BoatName.indexOf("visage") !== -1) return 12000;
  else if (BoatName.indexOf("nevermore") !== -1) return 3000;
  else if (BoatName.indexOf("sniper") !== -1) return 6000;
  else if (BoatName.indexOf("wind") !== -1) return 12000;
  else if (BoatName.indexOf("crystal") !== -1) return 1000;
  else if (BoatName.indexOf("phantom") !== -1) return 1000;
  else if (BoatName.indexOf("vengefulspirit") !== -1) return 750;
  else if (BoatName.indexOf("enigma") !== -1) return 8000;
  else if (BoatName.indexOf("bane") !== -1) return 4000;
  else if (BoatName.indexOf("pugna") !== -1) return 12000;
  else if (BoatName.indexOf("razor") !== -1) return 12000;
  else return 0;
}
...
function FadeShop() {
  ...
  if (ticksOfFade > 10 && FadeTrade) {
    $("#empty_guts").style.opacity = $("#empty_guts").style.opacity - 0.02;
  }
  ...
  if ($("#empty_guts").style.visibility == "visible") {
    $.Schedule(0.04, FadeShop);
  }
}

function isCloseEnough() {
  var heroloc = Entities.GetAbsOrigin(
  ...
  for (var i = 0; i < buildings.length; i++) {
    if (!Entities.IsTower(buildings[i])) {
      ...
      if (bldgloc) {
        var dist = Math.sqrt(
          Math.pow(heroloc[0] - bldgloc[0], 2) +
            Math.pow(heroloc[1] - bldgloc[1], 2)
        );
        if (dist < 600) {
...
function fillAndShow() {
  ...
  var hide = true;
  if (
    Math.abs(heroloc[1]) < 5000 &&
    Math.abs(heroloc[0]) > 1000 &&
    Math.abs(heroloc[0]) < 4000 &&
    closeEnough &&
      ...
      if (closeEnough) {
        ...
        if (heroloc[0] > 3000) {
          ...
          if (heroloc[1] < -2000) {
            ...
            Game.EmitSound(
              "announcer_dlc_lina_announcer_followup_neg_progress_05"
            );
          } else if (heroloc[1] > 2000) {
            $("#left_top_shop").style.visibility = "visible";
            Game.EmitSound(
              "announcer_dlc_bristleback_bris_ann_negative_event_03"
            );
          } else {
            $("#left_mid_shop").style.visibility = "visible";
            Game.EmitSound(
              "announcer_dlc_workshop_pirate_announcer_capn_misc2"
            );
          }
        } else {
...
function donate(amount) {
  GameEvents.SendCustomGameEventToServer("donate_" + amount, {
    text: "fooBar",
  });
}
...
function handleZoom() {
  ...
  if ($("#zoomLblVal").text != (zoomPer / 100) * 1600 + 1600) {
    GameUI.SetCameraDistance((zoomPer / 100) * 1600 + 1600);

    $("#zoomLblVal").text = (zoomPer / 100) * 1600 + 1600;
    ticksSinceChanged = 0;
  ...
  if (ticksSinceChanged > 60) {
    $("#ZoomSliderBox").style.opacity =
      $("#ZoomSliderBox").style.opacity - 0.04;
  }
...
function OnBattleTimer(eventData) {
  $.Msg(eventData);
  var tBattle =
    Math.floor(eventData.TimeTillBattle / 60) +
    ":" +
    (eventData.TimeTillBattle % 60 >= 10 ? "" : "0") +
    (eventData.TimeTillBattle % 60);
...
function OnBsuiTimer(eventData) {
  ...
  var tEmpire =
    Math.floor(eventData.nEmpire / 60) +
    ":" +
    (eventData.nEmpire % 60 >= 10 ? "" : "0") +
    (eventData.nEmpire % 60);
  var tCreep =
    Math.floor(eventData.nCreep / 60) +
    ":" +
    (eventData.nCreep % 60 >= 10 ? "" : "0") +
    (eventData.nCreep % 60);
  var t = Game.GetDOTATime(true, true) - starttime;
  var tGameTime =
    Math.floor(t / 60) + ":" + (t % 60 >= 10 ? "" : "0") + Math.floor(t % 60);
...
function diffCoOp(DiffSelection) {
  GameEvents.SendCustomGameEventToServer("DiffSelection", {
    diff: DiffSelection,
  });
...
function CannotBuy(data) {
  ...
  if (
    showMission[Players.GetLocalPlayer()] == 0 &&
...
function AddNotification(msg, panel) {
  ...
  if (msg.class) notification.AddClass(msg.class);
  else notification.AddClass("NotificationMessage");
...
function TeamWin(data) {
  ...
  for (var i = 0; i <= 9; i++) {
    ...
    if (
      rowPanel.GetChild(2).GetChildCount() > 0 &&
      rowPanel.GetChild(2).GetChild(0).text === highestKills + ""
    ) {
    ...
    if (
      rowPanel.GetChild(2).GetChildCount() > 0 &&
      rowPanel.GetChild(3).GetChild(0).text === lowestDeaths + ""
    ) {
    ...
    if (
      rowPanel.GetChild(2).GetChildCount() > 0 &&
      rowPanel.GetChild(4).GetChild(0).text === highestDamageTanked + ""
    ) {
    ...
    if (
      rowPanel.GetChild(2).GetChildCount() > 0 &&
      rowPanel.GetChild(5).GetChild(0).text === highestHeroDamage + ""
    ) {
    ...
    if (
      rowPanel.GetChild(2).GetChildCount() > 0 &&
      rowPanel.GetChild(6).GetChild(0).text === highestBuildingDamage + ""
    ) {
    ...
    if (
      rowPanel.GetChild(2).GetChildCount() > 0 &&
      rowPanel.GetChild(7).GetChild(0).text === highestCreepsKilled + ""
    ) {
    ...
    if ("undefined" !== typeof PlayerPointsMap[i]) {
      ...
      PlayerPointsMap[i].points = Math.floor(
        ((PlayerPointsMap[i].points * numPlayers) / 10) * 2
      );

      GameEvents.SendCustomGameEventToServer("AddPoints", {
        playerSteamId: GetSteamID32(PlayerPointsMap[i].pid),
        points: PlayerPointsMap[i].points,
      });
      var rowPanel = $("#GameOverRow_" + i);
  ...
  $("#ScoreBoardFinalholder").SetParent(
    $("#ScoreBoardFinalholder").GetParent().GetParent().GetParent().GetParent()
  );
...
function SetSouth() {
  if (
    $.GetContextPanel()
      ...
      .GetParent()
      .GetParent()
      .FindChildTraverse("GameEndContainer")
      .FindChildTraverse("GameEnd")
  ) {
    var vicLabel = $.GetContextPanel()
      .GetParent()
      .GetParent()
      .GetParent()
      .FindChildTraverse("GameEndContainer")
      .FindChildTraverse("GameEnd")
      .FindChildTraverse("WinLabelContainer")
      .FindChildTraverse("VictoryLabel");
    var vicBak = $.GetContextPanel()
      .GetParent()
      .GetParent()
      .GetParent()
      .FindChildTraverse("GameEndContainer")
      .FindChildTraverse("GameEnd")
      .FindChildTraverse("WinLabelContainer")
      .FindChildTraverse("VictoryBackgroundScene");
    vicBak.style.visibility = "collapse";
    var vicHoldder = $.GetContextPanel()
      .GetParent()
      .GetParent()
      .GetParent()
      .FindChildTraverse("GameEndContainer")
    ...
    var continueButton = $.GetContextPanel()
      .GetParent()
      .GetParent()
      .GetParent()
      .FindChildTraverse("GameEndContainer")
      .FindChildTraverse("GameEnd")
      .FindChildTraverse("ContinueButton");
    ...
    $.GetContextPanel()
      ...
      .GetParent()
      .FindChildTraverse("GameEndContainer")
      .FindChildTraverse("GameEnd").style.height = "100%";
  }
  $.Schedule(0.1, SetSouth);
}
...
function SetNorth() {
  if (
    ...
    $.GetContextPanel()
      ...
      .FindChildTraverse("GameEndContainer")
      .FindChildTraverse("GameEnd")
      .FindChildTraverse("WinLabelContainer").style.visibility = "visible";
    var vicHoldder = $.GetContextPanel()
      .GetParent()
      .GetParent()
      .GetParent()
...
function OnMouseClicked(button) {
  ...
  try {
    ...
    var accurateEntities = mouseEntities.filter(function (e) {
      return e.accurateCollision;
    });
    if (accurateEntities.length > 0) {
      for (var e of accurateEntities) {
        if (
          Entities.IsDisarmed(e.entityIndex) &&
        ...
        if (
          Entities.IsHexed(e.entityIndex) &&
          Entities.NoHealthBar(e.entityIndex)
        ) {
          //$.Msg("INVULNERABLE UNIT CLICKED")
          showShips();
    ...
    if (mouseEntities.length > 0) {
      ...
      if (
        Entities.IsFrozen(e.entityIndex) &&
        Entities.NoHealthBar(e.entityIndex)
      ) {
