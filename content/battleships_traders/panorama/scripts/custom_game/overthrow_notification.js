...
function OnItemDrop(msg) {
  ...
  $("#PickupMessage_Hero_Text").SetDialogVariable(
    "hero_id",
    $.Localize("#" + msg.hero_id)
  );
  $("#PickupMessage_Item_Text").SetDialogVariable(
    "item_id",
    $.Localize("#DOTA_Tooltip_Ability_" + msg.dropped_item)
  );
  ...
  var item_image_name =
    "file://{images}/items/" + msg.dropped_item.replace("item_", "") + ".png";
...
function AlertTimer(data) {
  ...
  if (
    data.timer_minute_01 == 2 &&
    data.timer_second_10 == 0 &&
    data.timer_second_01 == 0
  ) {
  ...
  if (
    data.timer_minute_01 == 0 &&
    data.timer_second_10 == 3 &&
    data.timer_second_01 == 0
  ) {
  ...
  if (
    data.timer_minute_01 == 0 &&
    data.timer_second_10 == 2 &&
    data.timer_second_01 == 5
  ) {
    $.GetContextPanel().SetHasClass("time_notification", false);
  }
  if (
    data.timer_minute_01 == 0 &&
    data.timer_second_10 == 1 &&
    data.timer_second_01 == 0
  ) {
    remainingText = "10";
    $.GetContextPanel().SetHasClass("time_notification", true);
...
function OnLeaderKilled(msg) {
  ...
  $("#KillMessage_Hero").SetDialogVariable(
    "hero_id",
    $.Localize("#" + msg.hero_id)
  );
